...
import { BarChart3, MessagesSquare, Palette, PanelRight, ShieldCheck, Workflow } from 'lucide-react'

export type SettingsSection = 'chat' | 'usage' | 'appearance' | 'tools' | 'execution' | 'privacy'
